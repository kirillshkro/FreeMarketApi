"""
Django settings for FreeMarketApi project.
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'rest_framework',
    'freemarketapi.apps.FreemarketapiConfig'
]
...
ROOT_URLCONF = 'FreeMarketApi.urls'
...
WSGI_APPLICATION = 'FreeMarketApi.wsgi.application'
